...
<html>
	...
	<body>
		<div class="container-fluid login-container">
			<div class="row-fluid">
				<div class="span3">
					<div class="logo"><img src="layouts/vlayout/skins/images/crm-plus-logo_240x60.png">
					<br />
					<a target="_blank" href="http://{$COMPANY_DETAILSCOMPANY_DETAILS.website}">{$COMPANY_DETAILS.name}</a>
					</div>
				</div>
				<!-- danzi.tn@20150428 rimozione helpLinks
				<div class="span9">
					<div class="helpLinks">
					...
					<div class="content-wrapper">
						<div class="container-fluid">
							<div class="row-fluid">
								<div class="span6">
								    &nbsp;
							        <!-- danzi.tn@20150428 rimozione carousal
				...
				<div class="container-fluid">
					<div class="row-fluid">
						...
						<div class="span6 pull-right" >
						    <!-- danzi.tn@20150428 rimozione social
