...
class Rumors_RumorsByStatus_Dashboard extends Vtiger_IndexAjax_View {
 
    function getSearchParams($value,$assignedto = '',$dates) {
        $listSearchParams = array();
        $conditions = array(array('rumor_status','e',$value));
	...
	public function process(Vtiger_Request $request) {
		...
		$data = $moduleModel->getRumorsByStatus($request->get('owner'), $dates);
		...
		if(!empty($content)) {
			...
			$viewer->view('dashboards/RumorsByStatus.tpl', $moduleName);
		}
	}
}
